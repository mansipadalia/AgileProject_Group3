...
public class Test_MarriageDivorceDates {
	...
	// US06
		@Test
		public void testdivorceBeforeDeath_Error() {
			...
			family.setProperty(PropertyType.husbandID, new Property("I01", 6));
			family.setProperty(PropertyType.wifeID, new Property("I02", 7));
			family.setProperty(PropertyType.divorced, new Property(LocalDate.of(2015, 01, 01), 8));
			FList.add(family);

			Parser p = new Parser(IList, FList);
			
			List<Error> errors = US_MarriageDivorceDates.divorceBeforeDeath(p);
			...
			error.setLineNumber(8);
			error.setId("F01");
			error.setMessage("Divorce Date 2015-01-01 (F01) occurs after Death Date 2010-01-01 of Individual I01");
		...
		// US06
		@Test
		public void testdivorceeBeforeDeath_Valid() {
			...
			family.setProperty(PropertyType.husbandID, new Property("I01", 6));
			family.setProperty(PropertyType.wifeID, new Property("I02", 7));
			family.setProperty(PropertyType.divorced, new Property(LocalDate.of(2005, 01, 01), 8));
			FList.add(family);
		...
		// US06
		@Test
		public void testdivorceBeforeDeath_IndividualNull() {
			List<Record> IList = new ArrayList<Record>();
			List<Record> FList = new ArrayList<Record>();

			Record family = new Record();
			family.setProperty(PropertyType.id, new Property("F01", 1));
			family.setProperty(PropertyType.divorced, new Property(LocalDate.of(1998, 10, 7), 2));
			FList.add(family);
		...
		// US06
		@Test
		public void testdivorceBeforeDeath_DeathDtNull() {
			List<Record> IList = new ArrayList<Record>();
			List<Record> FList = new ArrayList<Record>();
			...
			List<Error> errorDeath = US_MarriageDivorceDates.divorceBeforeDeath(p);
			assertEquals(0, errorDeath.size());
		}
		
		// US06
		@Test
		public void testdivorceBeforeDeath_MarriageDtNull() {
			List<Record> IList = new ArrayList<Record>();
			List<Record> FList = new ArrayList<Record>();
